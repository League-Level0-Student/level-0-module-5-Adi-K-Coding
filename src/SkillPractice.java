...
public class SkillPractice {
	...
	void skill4() { // In a pop-up, ask the user for the city they live in
		...
		JOptionPane.showMessageDialog(null, "My family has 2 cars.");

		int cars = 2;

		JOptionPane.showMessageDialog(null, "The number of tires in all the cars my family has is " + (cars * 4)+".");
	...
	void skill5() { // In a pop-up, ask the user for the name of their school
		...
		JOptionPane.showMessageDialog(null, "Wow, your school " + school + " is fantastic!");
